...
npx -y nodemon --watch "src/**/*.{ts,js,mjs,cjs}" --watch "rollup.*.{js,mjs}" --ext "js,ts,cjs,mjs" --ignore "tmp,node_modules" --delay 10 --exec "set ROLLUP_ENTRIES=src/openai-server/start.ts && rollup -c && node dist/openai-server/start.cjs"
